...
import {TestEnvironment, TEST_NEO4J_VERSIONS} from '../../utils/system';
            ...
            .reply(200, [
                {
                    ...
                    downloadUrl:
                        'https://github.com/neo4j-contrib/neo4j-apoc-procedures/releases/download/4.3.0.6/apoc-4.3.0.6-all.jar',
