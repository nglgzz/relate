...
import {TestEnvironment, TEST_NEO4J_CREDENTIALS, TEST_NEO4J_VERSIONS} from '../../utils/system';
...
describe('LocalDbmsPlugins', () => {
    ...
    test('dbmsPlugins.install - installs apoc successfully', async () => {
        ...
        expect(installedVersion.toArray()[0].version.version).toEqual('4.4.0.6');
        ...
        expect(res.get('apocVersion')).toEqual('4.4.0.6');
    });
